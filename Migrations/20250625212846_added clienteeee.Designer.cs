...
namespace Management.Server.Migrations
{
    ...
    [Migration("20250625212846_added clienteeee")]
    partial class addedclienteeee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Management.Server.Models.AjusteDeudaManual", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal>("CantidadAjustada")
                    ...
                    b.Property<DateTime>("MesAplicado")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("TipoAjusteInterno")
                        .IsRequired()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Management.Server.Models.PagoMembresia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MembresiaId", "MesDePago")
                        .IsUnique();
            ...
            modelBuilder.Entity("Management.Server.Models.Membresia", b =>
                {
                    ...
                    b.HasOne("Management.Server.Models.Cliente", "Usuario")
                        .WithMany("Membresias")
            ...
            modelBuilder.Entity("Management.Server.Models.Membresia", b =>
                {
                    b.Navigation("AjustesDeudaManual");

                    b.Navigation("PagosGenerales");
